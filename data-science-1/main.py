...
#q1
dataframe.describe().iloc[4:7]
quartis = dataframe.describe().iloc[4:7]
result = round(quartis['normal'] - quartis['binomial'],3)
tuple(result)
...
prob = float(round(ecdf(sup) - ecdf(inf), 3))
prob
...
false_pulsar_mean_profile_standardized = (df_filtered - df_filtered.mean())/df_filtered.std()
...
def q5():
    ...
    return tuple(diff_quantile.round(3))
